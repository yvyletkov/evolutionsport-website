...
function templates(e, desc, img) {
  return `<div class="item">
              <a href="#">
                <img class="img-fluid" src="img/eventCalendar/${img}" alt="Акция! Специальное предолжение на Cooper Pass"/>
              </a>
...
const oldNews = [
  {
    value: "Соревнования по плаванию «Evolution Open»",
    desc:
      "Приглашаем Вас принять участие в соревнованиях по плаванию «Evolution open» в Центре Спорта «Эволюция»",
    img: "news_sweeming.jpg",
  },
  {
    value: "SUP Йога<br>в Центре Спорта<br>«Эволюция»",
    desc: "Практика йоги на SUP-досках на воде",
    img: "news_yoga.jpg",
  },
  {
    value: "Зажигательные тренировки на берегу моря",
    desc: "ZUMBAFIT в Центре Спорта «Эволюция»!",
    img: "news_zumba.jpg",
  },
];

// dataNews.map((e) => {
//   const formatDate = new Date(e.date).setMonth(+new Date(e.date).getMonth() - 1);
//   e.date = new Date(formatDate).format("yyyy-mm-dd");
// });
